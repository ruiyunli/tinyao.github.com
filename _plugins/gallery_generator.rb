      ...
      Dir.foreach(dir) do |image|
        if image.chars.first != "." and image.downcase().end_with?(*$image_extensions)
          ...
          begin
            ...
            simage_info= "时间: " + image_exif_date  +"   相机: "+ image_exif.model
#+ " 快门:"+ image_exif.exposure_time.to_s+ " 焦距:" + image_exif.focal_length.to_f.to_s + "mm 光圈:F" + image_exif.f_number.to_f.to_s+ " ISO:" + image_exif.iso_speed_ratings.to_s
